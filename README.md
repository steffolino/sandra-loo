...
The awareness game now uses a pure shared game core with a 2D Phaser-based client scene rather than a free-roam world.
...
- The game HUD now lives inside the Phaser scene, including bladder, igitt, step, pressure, and score
